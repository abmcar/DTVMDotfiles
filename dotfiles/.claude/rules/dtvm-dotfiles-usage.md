...
- `.agents/skills/` — **mostly** upstream-tracked skills, managed by the DTVM
  repo. **Exception**: `.agents/skills/worktree-bootstrap/` is a personal
  skill (untracked, dotfiles-managed). Its lightweight mirror at
  `.claude/skills/worktree-bootstrap/SKILL.md` is regenerated by
